...
export const APPS: AppEntry[] = [
  ...
  },
  {
    id: 'lotfinder',
    name: 'Lotfinder',
    description: 'Mapa dos empreendimentos: cada lote por status e preço.',
    url: 'https://lotfinder.youngempreendimentos.com.br/',
    icon: MapPinned,
    category: 'comercial',
    status: 'ativo',
    tech: 'Lovable',
  },
  {
    ...
    description: 'Monta a proposta (entrada, parcela, prazo, reforços) e gera o contrato.',
    url: 'https://simulador.youngempreendimentos.com.br/',
